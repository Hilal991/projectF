...
public class Utils {
    ...
    public static final String FCM_SERVER_KEY="AAAAT-EjuNY:APA91bFmAiw_gZ2hZ8FhgRga9SIv_wi8gNWdfTD7nfZ84kYP6BGmtKZ_aRccZg_i4ADNI90HMeamRODE_TfyxMg49ToXJBB4RWVKUReTMKRYlAkHpM4PXknFR4zETdVISn34pcT0uWGA";




    public static final String[] categories={"mobiles", "computer", "electronics", "vehicles", "furniture", "fashion", "books", "sports", "animals", "business", "agriculture"};
    ...
    public static final String[] conditions={"new","Used","Refurbished","Fresh"};
    ...
    public static String formatTimestampDateTime(Long timestamp){
        ...
        String date= DateFormat.format("dd/MM/yy hh/mm/a", calendar.getTime()).toString();
