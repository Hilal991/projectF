...
import com.mubadara.mubadara2023.databinding.ActivityProfileEditBinding;
            ...
            ref.putFile(imageUri)
                    ...
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            ...
                            Utils.toast(profileEditActivity.this,"Failed to upload profile image dur to "+e.getMessage());
