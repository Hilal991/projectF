...
import com.mubadara.mubadara2023.databinding.ActivityLocationPickerBinding;
        ...
        binding.toolbarGpsBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (isGPSEnabled()){
                    ...
                    Utils.toast(LocationPickerActivity.this,"Location is not true show current location !");
...
private ActivityResultLauncher<String> requestLocationPermission= registerForActivityResult(
    ...
    private boolean isGPSEnabled(){
        ...
        try {
            networksEnabled = lm.isProviderEnabled(LocationManager.NETWORK_PROVIDER);
        } catch (Exception e){
            Log.e(TAG, "isGPSEnabled: ", e);
        }

        return !(!gpsEnabled && !networksEnabled);
    }
