...
import com.mubadara.mubadara2023.adapters.AdapterChat;
import com.mubadara.mubadara2023.databinding.ActivityChatBinding;
import com.mubadara.mubadara2023.models.ModelChat;
...
public class ChatActivity extends AppCompatActivity {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        for (DataSnapshot ds: snapshot.getChildren()){
                            ...
                            try {
                                ...
                                Log.e(TAG, "loadMessage:onDataChange: ",e );
                            }
                        }
            ...
            new ActivityResultCallback<Map<String, Boolean>>() {
                ...
                public void onActivityResult(Map<String, Boolean> result) {
                    ...
                    if (areAllGranted){
                        ...
                        Log.d(TAG, "onActivityResult: Camera or Storage of both permissions denied..!");
                        Utils.toast(ChatActivity.this,"Camera or Storage of both permissions denied..!");
                    }
                }
            }
    );
    ...
    private ActivityResultLauncher<Intent> cameraActivityResultLauncher=registerForActivityResult(
        ...
        private ActivityResultLauncher<Intent> gallerActivityResultLauncher=registerForActivityResult(
                new ActivityResultContracts.StartActivityForResult(),
                new ActivityResultCallback<ActivityResult>() {
                    @Override
                    public void onActivityResult(ActivityResult result) {
        ...
        private void uploadToFirebaseStorage(){
            ...
            String filePathAndName = "ChatImage/"+timestamp;
            ...
            refChat.child(chatPath)
                    ...
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            Log.e(TAG, "onFailure: ",e );
                            progressDialog.dismiss();
                            Utils.toast(ChatActivity.this,"Failed to send dur to"+e.getMessage());
                        }
                    });
