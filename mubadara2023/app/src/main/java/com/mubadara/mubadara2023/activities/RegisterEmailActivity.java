...
import com.mubadara.mubadara2023.databinding.ActivityRegisterEmailBinding;
            ...
            firebaseAuth.createUserWithEmailAndPassword(email,password)
                    ...
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            ...
                            Utils.toast(RegisterEmailActivity.this,"Failed to "+e.getMessage());
        ...
        reference.child(registerUserUid)
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        Log.e(TAG,"onFailure:  ",e);
                        progressDialog.dismiss();
                        Utils.toast(RegisterEmailActivity.this, "Failed to save info sue to  "+e.getMessage());
